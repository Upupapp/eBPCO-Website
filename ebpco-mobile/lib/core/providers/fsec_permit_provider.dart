...
/// Holds the single in-progress FSEC for Building Permit (BFP) application
...
class FsecPermitProvider extends ChangeNotifier {
  ...
  /// Marks the current draft as submitted (Step 6 → Application
