...
/// Holds the single in-progress FSIC for Occupancy Permit (BFP)
/// application draft for the current app session (frontend-only: nothing
/// here is persisted to disk or a server). Mirrors the other permit
...
class FsicPermitProvider extends ChangeNotifier {
  ...
  /// Marks the current draft as submitted (Step 5 → Application
