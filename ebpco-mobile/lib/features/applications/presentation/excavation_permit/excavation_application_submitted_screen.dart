...
/// Terminal confirmation screen shown after Step 9's Submit Application
/// is pressed — sits outside the numbered 9-step flow, matching how
/// every other permit wizard closes out its flow. Surfaces the related
/// Building Permit's status. Uses [FormScrollScaffold] (rather than an
/// unwrapped `Center`/`Column`) so this content scrolls instead of
/// overflowing on shorter Android viewports.
                  ...
                  AppCard(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'This permit does not guarantee the granting '
                            'of your related Building Permit application.',
