...
/// sits outside the numbered 9-step flow, matching how the other eight
/// permit wizards close out their flows. Surfaces the related Building
/// Permit's status.
class SanitaryPlumbingApplicationSubmittedScreen extends StatelessWidget {
  final String referenceNumber;
  final DateTime submissionDate;
  final String relatedBuildingPermitNumber;
  final String relatedBuildingPermitStatus;

  const SanitaryPlumbingApplicationSubmittedScreen({
    super.key,
