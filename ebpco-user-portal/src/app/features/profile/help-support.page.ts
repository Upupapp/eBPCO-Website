  ...
  template: `
    <div class="page" style="max-width:700px;">
      ...
      <div class="card">
        ...
        <p class="small muted">Business Permit and Clearance Office, Castilla Municipal Hall, Castilla, Sorsogon</p>
...
export class HelpSupportPage {
  ...
  readonly faqs: Faq[] = [
    ...
    { q: 'What payment methods are accepted?', a: 'Bank Transfer (with proof of payment) and Onsite payment at the Business Permit and Clearance Office.' },
